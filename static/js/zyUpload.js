		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
				    ...
				    html += '							<img class="upload_image" src="add_img.png"/*tpa=http://www.17sucai.com/preview/41468/2014-07-08/zyUpload/control/js/control/images/add_img.png*/ style="width:expression(this.width > '+imgWidth+' ? '+imgWidth+'px : this.width)" />';
				    html += '						</div>';
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				// 处理不同类型文件代表的图标
				var fileImgSrc = "index.htm"/*tpa=http://www.17sucai.com/preview/41468/2014-07-08/zyUpload/control/js/control/images/fileType/*/;
